        ...
        public static Address parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"address".equals(type)) {
                            ...
                            return (Address) contact.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "street").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "city").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "postcode").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
