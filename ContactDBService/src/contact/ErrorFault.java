...
public class ErrorFault extends java.lang.Exception {
    private static final long serialVersionUID = 1615291208654L;
    private contact.Error faultMessage;
    ...
    public void setFaultMessage(contact.Error msg) {
        faultMessage = msg;
    }

    public contact.Error getFaultMessage() {
        return faultMessage;
    }
}
