...
/**
 *  ContactDetail bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ContactDetail implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Address
     */
    protected contact.Address localAddress;
     ...
     * @param param Address
     */
    public void setAddress(contact.Address param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":contactDetail", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "contactDetail", xmlWriter);
            }
        }

        namespace = "urn:Contact";
        ...
        localAddress.serialize(new javax.xml.namespace.QName("urn:Contact",
                "address"), xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ContactDetail parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ContactDetail object = new ContactDetail();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"contactDetail".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ContactDetail) contact.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "firstname").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "surname").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setPhonenumber(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("urn:Contact", "address").equals(
                            reader.getName())) {
                    object.setAddress(contact.Address.Factory.parse(reader));
